...
export const blogLinks: BlogLink[] = [
  ...
  },
  {
    ...
    date: '2026-05-20',
    author: 'ITV News Anglia East',
    description: '',
    url: 'https://www.youtube.com/watch?v=UFWGGFH6Cdw&t=679s',
    tags: ['conservation', 'community', 'press', 'video'],
    minor: true,
  },
  {
    id: 'bbc-radio-wales-hedgehogs',
    title: 'BBC Radio Wales Drive: Satellites and AI used to track UK hedgehogs (segment starts 28:00)',
    date: '2026-05-20',
    author: 'BBC Radio Wales',
    description: '',
    url: 'https://www.bbc.co.uk/sounds/play/m002wg09',
    tags: ['conservation', 'community', 'press'],
    minor: true,
  },
  {
    id: 'bbc-today-hedgehogs',
    title: 'BBC Today Programme: Satellites and AI used to track UK hedgehogs (segment starts 2:10:00)',
    date: '2026-05-19',
    author: 'BBC Radio 4',
    description: '',
    url: 'https://www.bbc.co.uk/sounds/play/m002wj61',
    tags: ['conservation', 'community', 'press'],
    minor: true,
  },
  {
    ...
    date: '2026-05-19',
    author: 'BBC News',
    description: 'BBC coverage of the Cambridge Conservation Initiative collaboration using TESSERA to map bramble habitats as a proxy for hedgehog population monitoring across the UK.',
    url: 'https://www.bbc.co.uk/news/articles/c202g60qrlpo',
    tags: ['conservation', 'community', 'press'],
    minor: true,
  },
  {
